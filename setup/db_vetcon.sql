...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vBatch` (
  `vbatch_id` MEDIUMINT(50) NOT NULL,
  ...
  INDEX `fk_vBatch_vFarm1_idx` (`vFarm_vfarm_id` ASC),
...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vCase` (
  `vcase_id` MEDIUMINT(50) NOT NULL,
  ...
  INDEX `fk_vCase_vClient1_idx` (`vClient_vclient_phone` ASC),
...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vCase_has_vDisease` (
  ...
  INDEX `fk_vCase_has_vDisease_vDisease1_idx` (`vDisease_vdisease_id` ASC),
  INDEX `fk_vCase_has_vDisease_vCase1_idx` (`vCase_vcase_id` ASC),
...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vClient` (
  ...
  INDEX `fk_vClient_vFarm1_idx` (`vFarm_vfarm_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vClient_has_vPet` (
  ...
  INDEX `fk_vClient_has_vPet_vPet1_idx` (`vPet_vpet_id` ASC),
  INDEX `fk_vClient_has_vPet_vClient1_idx` (`vClient_vclient_phone` ASC),
...
CREATE TABLE IF NOT EXISTS `db_vetcon`.`vUser_has_vCase` (
  ...
  INDEX `fk_vUser_has_vCase_vCase1_idx` (`vCase_vcase_id` ASC),
  INDEX `fk_vUser_has_vCase_vUser_idx` (`vUser_vuser_phone` ASC),
