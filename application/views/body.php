    ...
    <div class="container-fluid">
      <div class="center">
        <div class="col-md-6 col-md-offset-3">
          <h2>Our services</h2>
          <hr>
          <p class="lead">We provide professional, efficient and reliable veterinary services</p>
        </div>
      </div>
    </div>
    <div class="container-fluid">
      <div class="text-center">
        ...
        <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <img src="img/service/Treatment.jpg">
          <h3>Treatment</h3>
          <p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
        </div>
        <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
          <img src="img/service/surgery.jpg">
          <h3>Surgery</h3>
          <p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
        </div>
      </div>
    ...
    <div class="container-fluid">
      <div class="center">
        <div class="col-md-6 col-md-offset-3">
          <h2>Our Doctors</h2>
          <hr>
          <p class="lead">Our doctors are experienced, skilled and reliable</p>
        </div>
      </div>
    </div>
